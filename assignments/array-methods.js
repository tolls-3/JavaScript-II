...
runners.map(function(drunk){
  let upperCase = drunk.first_name.toUpperCase();
...
runners.filter(function(version){
  if(version.shirt_size === 'L'){
    runnersLargeSizeShirt.push(version)
  }
})
